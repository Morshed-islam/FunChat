...
import com.techmorshed.funchat.model.Conversation;
...
public class ChatsFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mConvDatabase = FirebaseDatabase.getInstance().getReference().child("FunChat_Chat").child(mCurrent_user_id);


        mConvDatabase.keepSynced(true);
        mUsersDatabase = FirebaseDatabase.getInstance().getReference().child("FunChatUsers");
        mMessageDatabase = FirebaseDatabase.getInstance().getReference().child("FunChatMessages").child(mCurrent_user_id);
    ...
    public void onStart() {
        ...
        FirebaseRecyclerAdapter<Conversation, ConvViewHolder> firebaseConvAdapter = new FirebaseRecyclerAdapter<Conversation, ConvViewHolder>(
                Conversation.class,
                R.layout.chat_user_single_layout,
